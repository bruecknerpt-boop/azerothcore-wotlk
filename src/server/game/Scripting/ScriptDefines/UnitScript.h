...
enum UnitHook
{
    ...
    UNITHOOK_ON_BEFORE_CALC_SPELL_MISS_RESULT,
    UNITHOOK_ON_BEFORE_CALC_PHYSICAL_MISS_CHANCE,
    UNITHOOK_END
};
...
public:
    ...
    virtual bool OnBeforeCalcPhysicalMissChance(Unit const* /*attacker*/, Unit const* /*victim*/, WeaponAttackType /*attType*/, float& /*missChance*/) { return false; }

    virtual bool OnBeforeCalcSpellMissResult(Unit* /*attacker*/, Unit* /*victim*/, SpellInfo const* /*spellInfo*/, SpellMissInfo& /*missInfo*/) { return false; }
